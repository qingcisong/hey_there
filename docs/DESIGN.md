...
# Part 5 — Technology design (previous version — under reconsideration)

> This section reflects the stack decided in the earlier design pass. The
> team is now reconsidering the technology approach — see the note at the
> end of this section — so treat everything below as prior art, not as a
> locked decision.
